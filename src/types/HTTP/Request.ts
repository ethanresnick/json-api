...
export class Request {
  ...
  public primary: any;
  public queryParams: { [paramName: string]: any };
  ...
  constructor() {
    ...
    // The id provided in the request's url, if any.
    // Note also: the request could be something like /people/1/author,
    // so the id stored here may not be the id of the requested resource(s).
    Object.defineProperty(this, "id", {writable: true, enumerable: true});
    ...
    Object.defineProperty(this, "type", {writable: true, enumerable: true});
